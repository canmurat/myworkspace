...
public class SearchUtilities {
	...
	/**
	 * Given a search engine name and a search string, builds a URL for the
	 * results page of that search engine for that query. Returns null if the
	 * search engine name is not one of the ones it knows about.
	 */
