 ...
 * Generated at: 2014-01-31 18:35:53 UTC
...
public final class yiyecek_005fguncelle_jsp extends org.apache.jasper.runtime.HttpJspBase
...
// degerler getParameter ile alÄ±ndÄ±. Sonradan int olanlar int'degiskene aktarÄ±ldÄ±.
...
// guncelleme degiskenleri common.jsp'de tanimli
	...
	session.setAttribute("guncel_yemek", " ("
      ...
      out.write(" -->\r\n");
      if (true) {
        _jspx_page_context.forward("yiyecek_duzenle.jsp" + "?" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("yemekId", request.getCharacterEncoding())+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode(String.valueOf(yemekId), request.getCharacterEncoding()));
        return;
      }
      out.write('\r');
      out.write('\n');
