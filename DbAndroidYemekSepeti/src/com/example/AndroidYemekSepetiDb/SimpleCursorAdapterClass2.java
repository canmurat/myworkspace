...
//		int SiparisIdIndex = cursor.getColumnIndex(VeriTabanýSiparisler.SIPARIS_ID);
...
//		int KullaniciIdIndex = cursor.getColumnIndex(VeriTabanýSiparisler.KULLANICI_ID);
...
//		int YemekIndex = cursor.getColumnIndex(VeriTabanýSiparisler.YEMEKLER);
...
//		int IcecekIndex = cursor.getColumnIndex(VeriTabanýSiparisler.ICECEKLER);
...
//		int SalataIndex = cursor.getColumnIndex(VeriTabanýSiparisler.SALATALAR);
...
//		int TatliIndex = cursor.getColumnIndex(VeriTabanýSiparisler.TATLILAR);
...
//		int ToplamIndex = cursor.getColumnIndex(VeriTabanýSiparisler.TOPLAM);
